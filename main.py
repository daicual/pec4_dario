...
def main():
    parser = argparse.ArgumentParser(description="Ejecución de ejercicios de la PEC4 - Programación para la Ciencia de Datos")
    parser.add_argument('-ex', '--exercise', type=int, help='Número de ejercicio a ejecutar (por ejemplo: -ex 3 ejecuta del 1 al 3)')
